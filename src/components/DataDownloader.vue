    ...
    >
      ...
      <div v-else class="data-downloader__rejected-container rejected-container">
        ...
        <p class="rejected-container__p-item p-item">
          If nothing has changed, please inform me of this incident by e-mail on <a class="link" href="mailto:yankaincode@gmail.com?subject=Error Report | Vue Project 'Data Exchange' by Yanka_InCode &body=Greets!%0A%0AI've tried to open 'Project: Data Exchange' tab, but it didn't download.%0AIt wasn't the Internet connection issue. Reload of the website and try to retrieve data from the server again by an appropriate button didn't help.">yankaincode@gmail.com</a>.
        </p>
      </div>
