<template>
  <footer class="footer-container">
    ...
    <svg class="footer-container__svg svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <a xlink:href="https://github.com/yankaincode/vue-project" target="_blank" rel="noopener" class="svg__svg-link svg-link" aria-label="View the code source of the project on GitHub">
